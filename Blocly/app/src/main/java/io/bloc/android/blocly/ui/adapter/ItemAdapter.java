    ...
    class ItemAdapterViewHolder extends RecyclerView.ViewHolder implements ImageLoadingListener,
        ...
        public ItemAdapterViewHolder (View itemView) {
            ...
            if (itemView.findViewById(R.id.tv_rss_item_feed_title) != null) {
                ...
                archiveCheckBox = (CheckBox) itemView.findViewById(R.id.cb_rss_item_favorite_star);
...
//                favoriteCheckBox.setOnCheckedChangeListener(this);
        ...
        void update (RssFeed rssFeed, RssItem rssItem) {
            ...
            //animateContent(getExpandedItem().getGuId() == rssItem.getGuId());
            if (getExpandedItem() != null) {
                animateContent(getExpandedItem().getGuId().equals(rssItem.getGuId()));
            }
        }
        ...
        private void animateContent (final boolean expand) {
            ...
            if ( expand ) {
                ...
                expandedContentWrapper.measure(View.MeasureSpec.makeMeasureSpec(content.getWidth(), View.MeasureSpec.EXACTLY),
