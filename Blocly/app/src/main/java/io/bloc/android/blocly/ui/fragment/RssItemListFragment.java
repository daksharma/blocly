...
/**
 * Created by Daksh on 1/18/16.
 */
public class RssItemListFragment extends Fragment implements ItemAdapter.DataSource, ItemAdapter.Delegate {

    private static final String BUNDLE_EXTRA_RSS_FEED = RssItemListFragment.class.getCanonicalName()
                                                                                 .concat(".EXTRA_RSS_FEED");
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh () {
                BloclyApplication.getSharedDataSource()
                                 .fetchNewItemsForFeed(currentFeed, new DataSource.Callback<List<RssItem>>() {
                                     @Override
