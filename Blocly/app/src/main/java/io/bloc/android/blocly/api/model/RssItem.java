...
public class RssItem {
    ...
    public RssItem (String riGuId, String riTitle, String riDescription, String riUrl, String riImageUrl, long riRssFeedId, long riDatePublished, boolean riFavorite, boolean riArchived) {
        this.guId = riGuId;
        this.title = riTitle;
